...
public class OpenSearchConsumer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(() -> {
            ...
            try {
                logger.info("Main thread : {} starts joining", mainThread.getName());
                mainThread.join();
        ...
        try(openSearchClient; consumer) {
            ...
            if (!indexExists) {
                ...
                logger.info("The Wikipedia index has been created!");
            } else {
                logger.info("The Wikipedia index already exists!");
            }
            ...
            while(true) {
                ...
                logger.info("Consumer records count: " + recordsCount);
                ...
                for (ConsumerRecord<String, String> record : records) {
                    ...
                    try {
                        ...
                        //logger.info("Inserted 1 document into Open Search Index with id: " + indexResponse.getId());
                    } catch (Exception e) {
